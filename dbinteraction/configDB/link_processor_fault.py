...
class Link_Processor_Fault(Base):
    """
    author: Evren Keskin
    Link_Processor_Fault class (link_processor_fault table)

    Describe a Link Processor Fault , which is composed of the device name,
    ...
    and specific to the link processor fault:
    positions x, y, and z
    ...
    ### LINK PROCESSOR FAULT SPECIFIC:
    position_x: an additional attribute for the link processor fault
    position_y: an additional attribute for the link processor fault
    position_z: an additional attribute for the link processor fault

    Relationships:
    --- None

    """
    __tablename__ = 'link_processor_fault'
    ...
    # link processor fault specific attributes:
